          ...
          <div className="flex items-center gap-2.5">
            ...
            <div className="relative group">
              <button
                ...
                className="flex items-center gap-1.5 bg-gradient-to-r from-[#1FB58A] to-[#3DDC97] text-white rounded-full shadow-sm shadow-[#1FB58A]/20 hover:shadow-md hover:scale-105 transition-all duration-300 ease-out px-2.5 h-8"
              >
                <span className="relative">
                  <Plus size={14} />
                  <Zap size={8} className="absolute -top-1 -right-1.5 text-yellow-300 animate-pulse" />
                </span>
                <span className="text-xs font-medium whitespace-nowrap max-w-0 overflow-hidden group-hover:max-w-[80px] transition-all duration-300">
                  Build
                </span>
              </button>
            </div>
