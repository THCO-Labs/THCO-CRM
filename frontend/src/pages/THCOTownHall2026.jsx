...
const DecorativeOval = ({ className = "", style = {} }) => (
  <div 
    className={`absolute rounded-full blur-3xl ${className}`}
    style={{ 
      background: `radial-gradient(ellipse, ${colors.purple}30, transparent)`,
      ...style 
    }}
  />
);
...
// Card Component
const Card = ({ children, accent, header, headerColor, className = "", dark = false }) => (
  <motion.div 
    variants={itemFade}
  ...
  >
    {header && (
      <div className="px-4 py-2 font-bold text-sm text-white" style={{ backgroundColor: headerColor || colors.purple }}>
        {header}
      </div>
    )}
...
const StatBox = ({ value, label, color = colors.purple, dark = true }) => (
  ...
  >
    ...
    <div className={`text-sm ${dark ? 'text-gray-300' : 'text-gray-600'}`}>{label}</div>
  </motion.div>
);
...
const SectionDivider = ({ title, subtitle }) => (
  <div className="h-full flex flex-col relative overflow-hidden" style={{ backgroundColor: colors.darkBg }}>
    <DecorativeOval className="w-96 h-96 top-10 -left-20" />
    <DecorativeOval className="w-80 h-80 bottom-20 right-10" />
...
const Slide1 = () => (
  <div className="h-full flex flex-col relative overflow-hidden" style={{ backgroundColor: colors.darkBg }}>
    <DecorativeOval className="w-[500px] h-[400px] top-20 right-20" />
    <DecorativeOval className="w-[300px] h-[300px] bottom-40 left-40" />
    ...
    <div className="flex-1 flex flex-col justify-center px-16 z-10">
      <motion.p 
        ...
        className="text-sm font-semibold tracking-[0.3em] mb-8"
        style={{ color: colors.teal }}
      >
        THCO
      </motion.p>
...
const Slide2 = () => (
  <div className="h-full flex flex-col justify-center items-center relative overflow-hidden px-16" style={{ backgroundColor: colors.darkBg }}>
    <DecorativeOval className="w-[600px] h-[400px] top-1/4 left-1/4" />
    ...
    >
      <p className="text-4xl font-bold text-white mb-2">The future is not coming.</p>
      <p className="text-4xl font-bold mb-8" style={{ color: colors.teal }}>The future is already here.</p>
      <p className="text-lg" style={{ color: colors.muted }}>And it is separating companies into two groups.</p>
    </motion.div>
  </div>
);
...
const Slide4 = () => (
  <div className="h-full flex flex-col p-12" style={{ backgroundColor: colors.lightBg }}>
    ...
    <motion.div variants={staggerChildren} initial="initial" animate="animate" className="grid grid-cols-4 gap-4 flex-1">
      {[
        ...
        { num: "2ND", era: "Late 1800s", tech: "Electricity & Steel", impact: "Living standards multiplied 3-5x.", color: "#5B21B6" },
        ...
        <motion.div key={i} variants={itemFade} className="rounded-xl overflow-hidden shadow-lg bg-white">
          <div className="py-3 text-center font-bold text-white text-lg" style={{ backgroundColor: rev.color }}>{rev.num}</div>
          <div className="p-4">
            <p className="text-sm font-semibold mb-1" style={{ color: colors.darkText }}>{rev.era}</p>
            <p className="text-sm font-bold mb-2" style={{ color: rev.color }}>{rev.tech}</p>
            <p className="text-xs" style={{ color: colors.bodyText }}>{rev.impact}</p>
          </div>
        </motion.div>
      ))}
    </motion.div>
    
    <motion.p variants={fadeIn} initial="initial" animate="animate" className="text-sm italic mt-6" style={{ color: colors.purple }}>
...
const Slide5 = () => (
  <div className="h-full flex flex-col p-12" style={{ backgroundColor: colors.lightBg }}>
    <motion.h1 variants={fadeIn} initial="initial" animate="animate" className="text-4xl font-bold mb-8" style={{ color: colors.darkText }}>
      Nokia vs Apple
    </motion.h1>
    
    <motion.div variants={staggerChildren} initial="initial" animate="animate" className="grid grid-cols-2 gap-8 flex-1">
...
const Slide6 = () => (
  <div className="h-full flex flex-col p-12" style={{ backgroundColor: colors.lightBg }}>
    ...
    <motion.div variants={staggerChildren} initial="initial" animate="animate" className="grid grid-cols-2 gap-6 mb-6">
...
const Slide7 = () => (
  <div className="h-full flex flex-col p-12 relative overflow-hidden" style={{ backgroundColor: colors.darkBg }}>
    <DecorativeOval className="w-[400px] h-[400px] bottom-0 right-0" />
    
    <motion.h1 variants={fadeIn} initial="initial" animate="animate" className="text-4xl font-bold text-white mb-8 z-10">
      Two Futures for THCO
    </motion.h1>
    
    <motion.div variants={staggerChildren} initial="initial" animate="animate" className="grid grid-cols-2 gap-8 flex-1 z-10">
    ...
    <motion.p variants={fadeIn} initial="initial" animate="animate" className="text-xl italic mt-6 z-10" style={{ color: colors.amber }}>
...
const Slide8 = () => (
  <div className="h-full flex flex-col p-12 relative overflow-hidden" style={{ backgroundColor: colors.darkBg }}>
    <motion.div variants={fadeIn} initial="initial" animate="animate" className="mb-6 z-10">
    ...
    <motion.div variants={staggerChildren} initial="initial" animate="animate" className="grid grid-cols-2 gap-6 flex-1 z-10">
      <div className="space-y-3">
        {[
          { wave: "Steam", impact: "Still feeling economic consequences 200 years later" },
          { wave: "Electricity", impact: "Parts of Nigeria still lack stable power in 2026" },
          { wave: "Internet", impact: "Deep broadband still a work in progress" },
        ].map((item, i) => (
          <motion.div 
            key={i}
            variants={itemFade}
    ...
    <motion.p variants={fadeIn} initial="initial" animate="animate" className="text-lg font-bold mt-6 z-10" style={{ color: colors.amber }}>
...
const Slide11 = () => (
  <div className="h-full flex flex-col p-12" style={{ backgroundColor: colors.lightBg }}>
    <motion.div variants={fadeIn} initial="initial" animate="animate" className="mb-6">
    ...
    <motion.div variants={staggerChildren} initial="initial" animate="animate" className="grid grid-cols-5 gap-3 mb-6">
      {[
        { name: "Advisory", desc: "Assess what's working and what isn't", color: "#5B21B6" },
        ...
        { name: "Academy", desc: "Upgrade people for the AI era", color: "#0F766E" },
        { name: "Operate", desc: "Manage it ongoing. Recurring revenue.", color: colors.amber },
      ].map((pillar, i) => (
        <motion.div key={i} variants={itemFade} className="rounded-xl overflow-hidden shadow-lg bg-white">
          <div className="py-2 text-center font-bold text-white text-sm" style={{ backgroundColor: pillar.color }}>{pillar.name}</div>
          <div className="p-3">
    ...
    >
      Advisory reveals gaps → Technology builds solutions → Talent fills roles → Academy trains teams → Operate manages ongoing
    </motion.div>
  </div>
);
...
const Slide12 = () => (
  <div className="h-full flex flex-col p-12" style={{ backgroundColor: colors.lightBg }}>
    ...
    <motion.div variants={staggerChildren} initial="initial" animate="animate" className="space-y-3 mb-8">
      {[
        { layer: "Senior Consultants", desc: "Client-facing. Strategic judgment. Trust.", width: "100%", color: colors.purple },
        { layer: "Expert Network", desc: "Domain specialists activated on demand.", width: "85%", color: colors.purple },
        { layer: "Proprietary AI", desc: "70% of all analytical work. Our moat.", width: "70%", highlight: true, color: "#5B21B6" },
        { layer: "Nigeria Operations", desc: "Execution, coordination, quality. The backbone.", width: "55%", color: colors.teal },
      ].map((item, i) => (
        <motion.div 
          key={i}
          variants={itemFade}
          className={`rounded-lg p-4 ${item.highlight ? 'shadow-lg' : ''}`}
          style={{ 
            width: item.width, 
    ...
    <motion.p variants={fadeIn} initial="initial" animate="animate" className="text-xl font-bold text-center" style={{ color: colors.darkText }}>
...
const Slide14 = () => (
  <div className="h-full flex flex-col p-12 relative overflow-hidden" style={{ backgroundColor: colors.darkBg }}>
    ...
    <motion.div variants={staggerChildren} initial="initial" animate="animate" className="grid grid-cols-4 gap-4 mb-8 z-10">
    ...
    <motion.div variants={fadeIn} initial="initial" animate="animate" className="z-10">
      ...
      <div className="grid grid-cols-3 gap-4">
        {[
          ...
          <div key={i} className="rounded-lg p-4" style={{ backgroundColor: 'rgba(255,255,255,0.05)', borderTop: `4px solid ${item.color}` }}>
...
const Slide15 = () => (
  <div className="h-full flex flex-col p-12" style={{ backgroundColor: colors.lightBg }}>
    ...
    <motion.div variants={staggerChildren} initial="initial" animate="animate" className="grid grid-cols-3 gap-4 flex-1">
      <div className="col-span-2 space-y-2">
        {[
          { step: "Lead Research", desc: "Daily: scans LinkedIn, news, job boards. 10-25 qualified prospects.", trigger: true },
          { step: "Email Outreach", desc: "Personalised cold emails. 50-100/day. Multi-step sequences." },
          { step: "Inbox + CRM", desc: "Real-time reply monitoring. Auto-categorise. Pipeline tracking." },
          { step: "Reactivation", desc: "Weekly batch: intelligence cards on dormant client accounts." },
          { step: "Meeting Prep", desc: "24hrs before: full briefing pack with competitive context." },
        ].map((item, i) => (
          <motion.div 
            key={i}
            variants={itemFade}
    ...
    <motion.p variants={fadeIn} initial="initial" animate="animate" className="text-sm italic mt-4" style={{ color: colors.purple }}>
...
const Slide16 = () => (
  <div className="h-full flex flex-col p-12" style={{ backgroundColor: colors.warmBg }}>
    ...
    <motion.div variants={staggerChildren} initial="initial" animate="animate" className="grid grid-cols-2 gap-4 mb-6">
      {[
...
const Slide17 = () => (
  <div className="h-full flex flex-col p-12" style={{ backgroundColor: colors.lightBg }}>
    <motion.h1 variants={fadeIn} initial="initial" animate="animate" className="text-3xl font-bold mb-6" style={{ color: colors.darkText }}>
    ...
    <motion.div variants={staggerChildren} initial="initial" animate="animate" className="space-y-3">
      ...
      {[
        { engine: "Advisory", trigger: "Engagement kicks off", pipeline: "Data requests, stakeholder maps, benchmarking", human: "Senior consultant refines and presents", color: "#5B21B6" },
        { engine: "Technology", trigger: "Project is signed", pipeline: "Spec-to-tasks, QA testing, scope creep detection", human: "Architecture decisions, ambiguous trade-offs", color: colors.teal },
        { engine: "Marketing", trigger: "Monthly content calendar", pipeline: "Blog articles, LinkedIn posts, newsletters", human: "Havilah sets direction, Godwin owns design", color: colors.purple },
        { engine: "Operations", trigger: "6 AM every morning", pipeline: "Project status, utilisation, invoicing, HR", human: "Victoria reviews dashboard, makes the calls", color: colors.amber },
      ].map((row, i) => (
        <motion.div key={i} variants={itemFade} className="grid grid-cols-4 gap-2 items-center">
          <div className="rounded-lg p-2 bg-white font-bold text-sm" style={{ borderLeft: `4px solid ${row.color}`, color: colors.darkText }}>{row.engine}</div>
          <div className="rounded-lg p-2 bg-white text-xs" style={{ color: colors.bodyText }}>{row.trigger}</div>
          <div className="rounded-lg p-2 bg-white text-xs" style={{ color: colors.bodyText }}>{row.pipeline}</div>
          <div className="rounded-lg p-2 bg-white text-xs" style={{ color: colors.bodyText }}>{row.human}</div>
        </motion.div>
      ))}
    </motion.div>
...
const Slide18 = () => (
  <div className="h-full flex flex-col p-12 relative overflow-hidden" style={{ backgroundColor: colors.darkBg }}>
    ...
    <motion.div variants={staggerChildren} initial="initial" animate="animate" className="z-10">
      <div className="flex items-center justify-center gap-2 mb-4 flex-wrap">
        {["Complete Project", "→", "Knowledge Capture", "→", "Content Generation", "→", "Publish to LinkedIn", "→", "Attract Leads", "→", "CRM + Meeting Prep"].map((step, i) => (
          step === "→" ? (
            <span key={i} style={{ color: colors.teal }}>→</span>
          ) : (
            <motion.div key={i} variants={scaleIn} className="rounded-lg px-3 py-2 text-xs text-white" style={{ backgroundColor: 'rgba(255,255,255,0.1)' }}>{step}</motion.div>
          )
        ))}
      </div>
      
      <p className="text-center text-sm mb-6" style={{ color: colors.muted }}>↻ Cycle restarts — every engagement makes the next one better</p>
    ...
    <motion.p variants={fadeIn} initial="initial" animate="animate" className="text-center italic mt-6 z-10 text-white">
...
const Slide20 = () => (
  <div className="h-full flex flex-col p-12" style={{ backgroundColor: colors.lightBg }}>
    ...
    <motion.div variants={staggerChildren} initial="initial" animate="animate" className="grid grid-cols-2 gap-6 flex-1">
      <div className="rounded-xl p-6" style={{ backgroundColor: colors.darkBg }}>
      ...
      <div>
        ...
        <div className="grid grid-cols-3 gap-2">
          {["1. Apply", "2. AI Screens", "3. Onboard", "4. Video Training", "5. Build Real Project", "6. Review & Graduate"].map((step, i) => (
            <motion.div key={i} variants={itemFade} className="rounded-lg p-2 text-center text-xs font-medium text-white" style={{ backgroundColor: colors.purple }}>
              {step}
            </motion.div>
          ))}
        </div>
...
const Slide21 = () => (
  <div className="h-full flex flex-col p-12" style={{ backgroundColor: colors.warmBg }}>
    <motion.h1 variants={fadeIn} initial="initial" animate="animate" className="text-4xl font-bold mb-6" style={{ color: colors.darkText }}>
      Product Portfolio
    </motion.h1>
...
const Slide23 = () => (
  <div className="h-full flex flex-col p-12" style={{ backgroundColor: colors.lightBg }}>
    ...
    <motion.div variants={staggerChildren} initial="initial" animate="animate" className="space-y-4 mb-6">
      {[
        { layer: "Layer 1", name: "Strategic Professionals", desc: "Client-facing. Partners, sales, engineering leadership, talent leads, brand. AI prepares everything — they deliver.", team: "Rebecca, Havilah, Godwin", color: "#5B21B6" },
        ...
        <motion.div key={i} variants={itemFade} className="rounded-xl p-5 bg-white" style={{ borderLeft: `6px solid ${item.color}` }}>
    ...
    <motion.p variants={fadeIn} initial="initial" animate="animate" className="text-sm" style={{ color: colors.purple }}>
...
const Slide24 = () => (
  <div className="h-full flex flex-col p-12 relative overflow-hidden" style={{ backgroundColor: colors.darkBg }}>
    ...
    <motion.div variants={staggerChildren} initial="initial" animate="animate" className="space-y-4 z-10">
      {[
        ...
        <motion.div key={i} variants={itemFade} className="rounded-lg p-4" style={{ backgroundColor: 'rgba(255,255,255,0.05)' }}>
...
const Slide25 = () => (
  <div className="h-full flex flex-col p-12" style={{ backgroundColor: colors.lightBg }}>
    ...
    <motion.div variants={staggerChildren} initial="initial" animate="animate" className="space-y-4 flex-1">
      {[
...
const Slide27 = () => (
  <div className="h-full flex flex-col p-12" style={{ backgroundColor: colors.lightBg }}>
    ...
    <motion.div variants={staggerChildren} initial="initial" animate="animate" className="grid grid-cols-2 gap-6 mb-6">
      <Card headerColor="#5B21B6" header="Extreme Ownership">
...
const Slide28 = () => (
  <div className="h-full flex flex-col p-12" style={{ backgroundColor: colors.warmBg }}>
    ...
    <motion.div variants={staggerChildren} initial="initial" animate="animate" className="grid grid-cols-2 gap-6">
      <div className="space-y-2">
        {["Decision-making under pressure", "Communication & management", "Execution rhythm", "Hiring & performance standards", "Leading in an AI-enabled world"].map((topic, i) => (
          <motion.div key={i} variants={itemFade} className="rounded-lg p-3 bg-white" style={{ borderLeft: `4px solid ${colors.purple}` }}>
  ...
  <div className="h-full flex flex-col p-12 relative overflow-hidden" style={{ backgroundColor: colors.darkBg }}>
    ...
    <motion.div variants={staggerChildren} initial="initial" animate="animate" className="space-y-4 z-10">
      {[
        ...
        <motion.div key={i} variants={itemFade} className="rounded-lg p-5" style={{ backgroundColor: 'rgba(255,255,255,0.05)', borderLeft: `6px solid ${item.color}` }}>
    ...
    <motion.p variants={fadeIn} initial="initial" animate="animate" className="text-xl font-bold mt-8 z-10" style={{ color: colors.amber }}>
...
const Slide33 = () => (
  <div className="h-full flex flex-col justify-center items-center relative overflow-hidden px-16" style={{ backgroundColor: colors.darkBg }}>
    <DecorativeOval className="w-[600px] h-[400px] top-20 right-20" />
    <DecorativeOval className="w-[400px] h-[300px] bottom-20 left-20" />
    ...
    <motion.div 
      ...
      className="text-center z-10"
    >
      <p className="text-lg mb-4" style={{ color: colors.muted }}>Steam. Electricity. Internet. Africa was late to all three.</p>
      <p className="text-xl font-bold text-white mb-6">AI is the fourth wave. We are not going to be late.</p>
...
const THCOTownHall2026 = () => {
  ...
  return (
    <div className="h-screen w-screen overflow-hidden relative" style={{ backgroundColor: colors.darkBg, fontFamily: "system-ui, -apple-system, sans-serif" }}>
      {/* Top Bar */}
      <div className="absolute top-0 left-0 right-0 h-12 flex items-center justify-between px-4 z-50 bg-white/95 backdrop-blur-sm border-b" style={{ borderColor: colors.lightBg }}>
        <button onClick={() => navigate(-1)} className="flex items-center gap-1 text-sm hover:opacity-70" style={{ color: colors.muted }}>
          <ArrowLeft className="w-4 h-4" />
          Back
        </button>
        <div className="flex items-center gap-2">
          <span className="text-xs font-semibold tracking-wider" style={{ color: colors.teal }}>THCO</span>
          <span className="text-xs" style={{ color: colors.muted }}>Town Hall 2026</span>
        </div>
        <button onClick={handleDownloadPdf} disabled={isGeneratingPdf} className="flex items-center gap-2 px-4 py-2 rounded-lg text-white text-sm font-medium hover:opacity-90 disabled:opacity-50" style={{ backgroundColor: colors.purple }}>
      ...
      {/* Navigation Arrows */}
      {currentPage > 1 && (
        <button onClick={prevPage} className="absolute left-4 top-1/2 -translate-y-1/2 w-12 h-12 rounded-full flex items-center justify-center hover:scale-110 transition-transform z-40" style={{ backgroundColor: colors.purple }}>
          <ChevronLeft className="w-6 h-6 text-white" />
        </button>
      )}
      {currentPage < totalPages && (
        <button onClick={nextPage} className="absolute right-4 top-1/2 -translate-y-1/2 w-12 h-12 rounded-full flex items-center justify-center hover:scale-110 transition-transform z-40" style={{ backgroundColor: colors.teal }}>
          <ChevronRight className="w-6 h-6 text-white" />
        </button>
      )}

      {/* Pagination Dots */}
      <div className="absolute bottom-4 left-0 right-0 flex items-center justify-center gap-1.5 z-40 flex-wrap px-8">
      ...
      {/* Page Counter */}
      <div className="absolute bottom-4 right-6 text-sm font-medium z-40" style={{ color: colors.teal }}>
        {currentPage} / {totalPages}
      </div>
    </div>
  );
...
export default THCOTownHall2026;
